...
const LANG = {
  en: {
    ...
    login_subtitle:'DOCTOR LOGIN',login_ph:'License Number',login_btn:'LOGIN',login_cancel:'Cancel',login_error:'Please enter your license number.',login_verifying:'Verifying...',login_not_found:'License not found or inactive. Please contact admin.',login_network_error:'Network error. Please try again.',
  ...
  ko: {
    ...
    login_subtitle:'의사 로그인',login_ph:'면허 번호',login_btn:'로그인',login_cancel:'취소',login_error:'면허 번호를 입력해주세요.',login_verifying:'확인 중...',login_not_found:'등록되지 않았거나 비활성화된 면허번호입니다. 관리자에게 문의해주세요.',login_network_error:'네트워크 오류가 발생했습니다. 다시 시도해주세요.',
  ...
  zh: {
    ...
    login_subtitle:'医生登录',login_ph:'执照号码',login_btn:'登录',login_cancel:'取消',login_error:'请输入执照号码。',login_verifying:'验证中...',login_not_found:'执照号码未注册或已停用，请联系管理员。',login_network_error:'网络错误，请重试。',
  ...
  th: {
    ...
    login_subtitle:'เข้าสู่ระบบทันตแพทย์',login_ph:'หมายเลขใบอนุญาต',login_btn:'เข้าสู่ระบบ',login_cancel:'ยกเลิก',login_error:'กรุณาใส่หมายเลขใบอนุญาต',login_verifying:'กำลังตรวจสอบ...',login_not_found:'ไม่พบหมายเลขใบอนุญาต หรือถูกระงับการใช้งาน กรุณาติดต่อผู้ดูแล',login_network_error:'เกิดข้อผิดพลาดเครือข่าย กรุณาลองใหม่อีกครั้ง',
